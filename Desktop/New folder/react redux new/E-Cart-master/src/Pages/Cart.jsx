...
import { emptyCart, incQuantity,decQuantity,removeCart } from '../Redux/Slices/cartSlice'
    ...
    <>
     <Header/>
      <div className='container mt-5'>
        ...
        <img width={'25%'} height={'200px'} src="https://statementclothing.net/images/cart.gif" alt="" />
