          ...
          <Row className='m-5'>
            ...
            <Card.Body>
              ...
              <div className='d-flex justify-content-between'>
                ...
                <span onClick={navigatePrev} className='btn btn-link'><i className='fa-solid fa-angles-left text-dark fw-bolder'></i>
                  </span>
                     <span className='mb-2'> {currentPage} of {totalPages}</span>
                  <span onClick={navigateNext} className='btn btn-link'><i className='fa-solid fa-angles-right text-dark fw-bolder'></i>
                  </span>
