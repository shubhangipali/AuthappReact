      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          { insideHome&&<Nav.Link className='me-lg-5'>
                <input onChange={e=>dispatch(productSearch(e.target.value.toLowerCase()))} style={{width:'400px'}} type="text" className="form-control rounded p-12" placeholder='Search Products...' />
            </Nav.Link>}
            <Nav.Link className=''>
